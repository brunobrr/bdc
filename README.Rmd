...
Prior to installing bdc, it is necessary to install [GNparser](https://github.com/gnames/gnparser#installation). First, download the [binary file](https://github.com/gnames/gnparser/releases/tag/v1.9.1) of `gnparser` for your operating system. For example, download the file using R as follows:
