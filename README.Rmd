...
:warning: The modules illustrated, and **functions** within, **can be linked to form** a **workflow** (see [**vignettes**](https://brunobrr.github.io/bdc/)), but **can also be executed independently** depending on user needs.
