...
test_that("bdc_filter_out_names misuse taxonomic status", {
  ...
  expect_error(bdc_filter_out_names(data = df_notes, col_name = "notes_a", 
...
test_that("bdc_filter_out_names collumn not contain valid taxonomic status", {
  expect_error(
    bdc_filter_out_names(data = df_notes, col_name = "notes_b", 
...
test_that("bdc_filter_out_names collumn containing taxonomic notes not found misapplied", {
  expect_error(
    bdc_filter_out_names(data = df_notes, col_name = "scientific.name", 
                         taxonomic_status = "accepted",
                         opposite = F))
})
...
test_that("bdc_filter_out_names data is not a data.frame", {
  expect_error(
    bdc_filter_out_names(data = df_notes$notes_b, col_name = "notes_b", 
                         taxonomic_status = "accepted",
                         opposite = F))
})