...
#'
#' Users must inform a distance used to create a buffer around the country
#' informed. Records in the ocean but within the informed distance are not
#' flagged.  a buffer for the country chosen by the user. See @details.
#'
