...
test_gnparser_setup <- function(bin_full_path){
  ...
  if (!exec_exists(bin_full_path)) message("GNparser is not installed in your machine. Please acess xx3 to get help to install gnparser")
}
...
#' from taxon name.
#' 
#' The execution of these functions depends on the gnparser software, which is not installed automatically. Please follow this tutorial xx1 to install gnparser.
#'
#' @family taxonomy
...
#' \bold{Note: GNparser is not automatically installed. Please follow this tutorial xx2 to install gnpaser}
#'
