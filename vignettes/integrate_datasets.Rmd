...
#   ),
#   columns = list(
#     fileName = reactable::colDef(minWidth = 700),   # 50% width, 200px minimum
#     datasetName = reactable::colDef(minWidth = 130)   # 25% width, 100px minimum
#   ),
# )
