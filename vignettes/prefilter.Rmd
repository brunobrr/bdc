...
if (!require("rnaturalearthdata")) remotes::install_github("ropensci/rnaturalearthdata")
...
**NOTE**: The results of the **VALIDATION** test used to flag data quality are appended in separate fields in this database and retrieved as TRUE or **FALSE**, in which the former indicates correct records and the **latter potentially problematic or suspect records.** We run bdc functions following a proposed workflow but all can be executed independently
