...
knitr::include_graphics("inst/extdata/example_figures/prefilter_coordinates_transposed_MAP.png")
```

```{r echo=F, out.width="80%", out.height= "80%", fig.cap = "Coordinates and contry inconsistent"}
knitr::include_graphics("inst/extdata/example_figures/prefilter_.coordinates_country_inconsistent_MAP.png")
```

```{r echo=F, out.width="80%", out.height= "80%", fig.cap = "Summary of all tests"}
knitr::include_graphics("inst/extdata/example_figures/prefilter_summary_all_tests_BAR.png")
```
