...
![Coordinates country inconsistent](https://github.com/brunobrr/bdc/blob/master/vignettes/images/prefilter_.coordinates_country_inconsistent_MAP.png?raw=true)
...
![Summary of all tests of the pre-filter step](https://github.com/brunobrr/bdc/blob/master/vignettes/images/prefilter_summary_all_tests_BAR.png?raw=true)
