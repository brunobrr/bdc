...
Creating a column named ".summary" summarizing the results of all **VALIDATION** tests. This column is **FALSE** if [any]{.ul} test was flagged as "FALSE" (i.e. potentially invalid or suspect record).
...
![Summary of all tests](https://github.com/brunobrr/bdc/raw/master/vignettes/inst/extdata/example_figures/prefilter_summary_all_tests_BAR.png){width="20cm"}
