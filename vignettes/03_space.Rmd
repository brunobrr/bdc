...
Read the database created in the [**taxonomy**](https://brunobrr.github.io/bdc/articles/02_taxonomy.html)step the BDC workflow. It is also possible to read any datasets containing the **required** fields to run the workflow (more details [here](https://brunobrr.github.io/bdc/articles/integrate_datasets.html%22)).
...
It is possible to map a column containing the results of **one spatial test each time**. For example, let's map records in country or provinces centroids.
...
Creating a column named **.summary** summing upthe results of all tests. This column is **FALSE** if any test was flagged as "FALSE" (i.e. potentially invalid or suspect record).
...
report <-
  bdc_create_report(data = check_space,
                    ...
                    workflow_step = c("taxonomy", "space"))
...
![Rounded coordinates (% of each database flagged)](https://github.com/brunobrr/bdc/raw/master/vignettes/inst/extdata/example_figures/space_.rou_BAR.png){width="20cm"}

<br/>

![Records within biodiversity institutions](https://github.com/brunobrr/bdc/raw/master/vignettes/inst/extdata/example_figures/space_.inst_MAP.png){width="20cm"}

<br/>

![Summary of all tests](https://github.com/brunobrr/bdc/raw/master/vignettes/inst/extdata/example_figures/space_summary_all_tests_BAR.png){width="20cm"}
