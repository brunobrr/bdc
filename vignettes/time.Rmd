...
report <-
  readr::read_csv(
    system.file("extdata/outpus_vignettes/04_Report_time.csv", package = "bdc"),
...
![Number of records sampled over the years](https://github.com/brunobrr/bdc/blob/master/vignettes/images/time_year_BAR.png?raw=true)

<br/>

![Summary of all tests of the time module; note that some database lack event date information](https://github.com/brunobrr/bdc/blob/master/vignettes/images/time_.summary_BAR.png?raw=true)

<br/>

![Summary of all validation tests of the bdc package](https://github.com/brunobrr/bdc/blob/master/vignettes/images/time_summary_all_tests_BAR.png?raw=true)
