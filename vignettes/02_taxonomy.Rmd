...
# read
parse_names <-
  readr::read_csv(here::here("inst/extdata/example_bdc_clean_names/example_bdc_names_clean.csv"))
...
query_names <-
  data.table::fread(
    here::here("extdata/example_bdc_query_names_taxadb/example_bdc_query_names_taxadb.csv")
  )
...
It also possible filter out records with taxonomic status different of "accepted". Such records may be potentially resolved manually.
