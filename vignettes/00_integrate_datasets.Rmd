...
metadata <- readr::read_csv(system.file(c("extdata/Config/DatabaseInfo.csv"), package = "bdc"))
```
...
config_description <-
  readr::read_csv(system.file("extdata", "Config", "DatabaseInfo_description.csv"), package = "bdc")
